<%@page import="com.java.web.bean.RateBean"%>
...
<%Map<String,RateBean> map= (Map<String,RateBean>) request.getAttribute("map");%>
...
// Create dummy data
<%-- var data = {male+<%=map.get("mrate").getAvg() %>: <%= map.get("mrate").getCnt()%>, female+<%=map.get("frate").getAvg() %>: <%=map.get("frate").getCnt() %>} --%>
var data = {10: <%=map.get("rate10").getAvg() %>, 20: <%=map.get("rate20").getAvg() %>,30:<%=map.get("rate30").getAvg() %>,40:<%=map.get("rate40").getAvg() %>,50:<%=map.get("rate50").getAvg() %>}
